                    ...
                    if col != '-1':
                        ...
                        if style == 'grass':
                            ...
                            Tile((x, y), [self.visible_sprites,
                                 self.obstacle_sprites, self.attack_sprites], 'grass', random_grass_image)
                        if style == 'object':
                            # create object tile
                        ...
                        if style == 'entities':
                            if col == '394':
                                self.player = Player(
                                    (x, y), [self.visible_sprites], self.obstacle_sprites, self.create_attack, self.destroy_attack, self.create_magic)
                            else:
                                if col == '390':
                                    monster_name = 'bamboo'
                                elif col == '391':
